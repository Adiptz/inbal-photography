      ...
      <div className="md:hidden">
        ...
        <div className="relative w-full aspect-[4/3] overflow-hidden">
          <Image
            ...
            priority
          />
          {/* Gradient overlay - blends into white */}
          <div className="absolute bottom-0 left-0 right-0 h-32 bg-gradient-to-t from-white to-transparent" />

          {/* Floating title on image */}
          <div className="absolute bottom-0 right-0 left-0 p-5 pb-0">
            <h1 className="text-[28px] font-sans font-medium text-text-primary leading-[1.2]">
              {t('title')}
            </h1>
          </div>
        </div>
        ...
        {/* Content */}
        <div className="px-5 pt-4 pb-6 text-right -mt-8 relative z-10 bg-white">
          {/* Lead */}
          <p className="text-[15px] text-text-primary leading-[1.6] mb-5">
            נעים מאוד, אני ענבל.
            <br />
            <span className="text-text-secondary">
              אמא לאגם, צלמת, ואוהבת רגעים קטנים עם משמעות גדולה.
          ...
          <div className="flex gap-3">
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="flex-1 inline-flex items-center justify-center gap-2 bg-accent hover:bg-accent-hover
                         text-white px-5 py-3 rounded-full text-[14px] font-medium
                         transition-all duration-300"
            >
            ...
            <Link
              href="/portfolio"
              className="flex-1 inline-flex items-center justify-center gap-2 bg-transparent border border-border
                         text-text-primary hover:border-accent hover:text-accent
